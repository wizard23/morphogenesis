...
export const COUNTERS = ["constraints", "collision_pairs", "bonds_formed", "springs_removed", "bin_max", "iterations", "max_step_disp_milli", "cell_overflow", "max_solve_disp_milli", "constraints_dropped"];
  ...
  return {
    ...
    counters: () => {
      ...
      COUNTERS.forEach((name, i) => {
        out[name] = (name === "bin_max" || name === "max_step_disp_milli" || name === "max_solve_disp_milli") ? e.perf_counter_total(i) : e.perf_counter_total(i) / frames;
      });
      return out;
    },
  };
